...
__all__ = [
    'originalDMPNNEncoder',
    'originalDMPNN'
]


class originalDMPNNEncoder(nn.Module):
    ...
    def __init__(self, node_in_dim:int, edge_in_dim:int, node_hidden_dim:int=64, depth:int=3, dropout:float=0.15,
        ...
        super(originalDMPNNEncoder, self).__init__()
...
class originalDMPNN(torch.nn.Module):
    ...
    def __init__(self, node_in_dim:int, edge_in_dim:int,node_hidden_dim:int=64, depth=3, dropout=0.15,
        ...
        super(originalDMPNN, self).__init__()
        ...
        self.encoder = originalDMPNNEncoder(node_in_dim = node_in_dim,
