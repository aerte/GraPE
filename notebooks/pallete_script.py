...
freq_dic_qm9 = pickle.load(open('./results/classyfire/qm9.pkl', 'rb'))
freq_dic_logp = pickle.load(open('./results/classyfire/logp.pkl', 'rb'))
freq_dic_freesolv = pickle.load(open('./results/classyfire/free1.pkl', 'rb'))
freq_dic_bradley = pickle.load(open('./results/classyfire/bradley.pkl', 'rb'))
...
fig.savefig('./results/plots/qm9.png')

plt.show()


# freq_dic = pickle.load(open('./results/classyfire/free0.pkl', 'rb'))
# #print(freq_dic)
